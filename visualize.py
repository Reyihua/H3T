...
from models.model_visual import VisionTransformer, CONFIGS, AdversarialNetwork
...
def visualize(args):
    ...
    len_ = len(image_list)
    images = [image_list[i].strip().split(" ")[0][0:] for i in range(len_)]
    print(images)
    for image_path in images:
        ...
        # TVT
        _, att_mat, trans_mat = model(x.unsqueeze(0), ad_net=ad_net, ad_net2=ad_net2)
